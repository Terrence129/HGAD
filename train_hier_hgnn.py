...
def main():
    ...
    # Tuned defaults: stronger regularization + wider threshold search for better recall/F1 balance.
    ...
    parser.add_argument("--latent-noise-std", type=float, default=0.08)
    parser.add_argument("--latent-reg-weight", type=float, default=2e-3)
    parser.add_argument("--denoise-std", type=float, default=0.05)
    ...
    parser.add_argument("--global-top-k", type=int, default=8)
    parser.add_argument("--val-ratio", type=float, default=0.1)
    parser.add_argument("--temporal-loss-weight", type=float, default=0.1)
    parser.add_argument("--score-weights", type=str, default="0.85,0.1,0.05")
    parser.add_argument("--percentiles", type=str, default="96.0,97.0,98.0,99.0,99.5")
